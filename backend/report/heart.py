...
# Constants
BASE_DIR = Path(__file__).resolve().parent.parent  # Adjust depending on file depth
MODEL_PATH = BASE_DIR / "models" / "best_svm_model.pkl"
FEATURES_PATH = BASE_DIR / "models" / "svm_model_features.pkl"
