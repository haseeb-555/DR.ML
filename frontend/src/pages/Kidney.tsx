...
const KidneyDisease = () => {
  ...
  const handlePredict = async () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `Kidney Disease Status: ${randomResult} (${randomConfidence}% confidence)`,
      });
    }, 3000);
  };
  ...
  const numericFields = [
    ...
    { key: 'specific_gravity', label: 'Specific Gravity', placeholder: '1.005 - 1.025', step: '0.001' },
